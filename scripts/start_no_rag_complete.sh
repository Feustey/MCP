...
# Script de démarrage sans RAG complet pour MCP
# Dernière mise à jour: 9 mai 2025

echo "🚀 Démarrage MCP sans RAG complet..."
...
# Désactiver les imports RAG problématiques
export PYTHONPATH="/app/src:/app"

echo "✅ Configuration sans RAG complet appliquée"
echo "📍 URL: http://0.0.0.0:8000"
echo "ℹ️ Toutes les fonctionnalités RAG sont désactivées"
